...
class Video extends Audio
{
    ...
    public function save(FormatInterface $format, $outputPathfile)
    {
        ...
        for ($i = 1; $i <= $totalPasses; $i++) {
            ...
            if ($totalPasses > 1) {
                ...
                $pass[] = $i;
                $pass[] = '-passlogfile';
                $pass[] = '/tmp/pass-59b11a74c2ddf';
                //$pass[] = $passPrefix; // TODO
            }
    ...
    /**
     * It creates a playlist file, and one or more segment files from a sequence of the video.
     * 
     * @param  Seconds $at
     * @param  Dimension $dimension
     * @param  integer $duration
     ...
     */
    public function hls($hlstime, $hlslistsize)
    {
        return new Hls($this, $this->driver, $this->ffprobe, $hlstime, $hlslistsize);
    }
