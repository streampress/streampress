...
if ( ! function_exists( 'understrap_widgets_init' ) ) {
	...
	function understrap_widgets_init() {
		register_sidebar( array(
			'name'          => __( 'Right Sidebar', 'streampress' ),
			'id'            => 'right-sidebar',
		...
		register_sidebar( array(
			'name'          => __( 'Left Sidebar', 'streampress' ),
			'id'            => 'left-sidebar',
		...
		register_sidebar( array(
			'name'          => __( 'Hero Slider', 'streampress' ),
			'id'            => 'hero',
		...
		register_sidebar( array(
			'name'          => __( 'Hero Static', 'streampress' ),
			'id'            => 'statichero',
		...
		register_sidebar( array(
			'name'          => __( 'Footer Full', 'streampress' ),
			'id'            => 'footerfull',
