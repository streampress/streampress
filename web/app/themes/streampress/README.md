...
### Classic install
- Download the streampress folder from GitHub or from [https://streampress.io](https://streampress.io)
- IMPORTANT: If you download it from GitHub make sure you rename the "streampress-master.zip" file just to "streampress.zip" or you might have problems using child themes !!
...
1. Go to "Settings -> General" and change "New User Default Role" to Author


## Install required plugins

### Streampress Video Post

### StreamPress Transcoder

## Buddypress

## AddToAny Share Buttons
- Install and activate plugin
- Go to: Settings -> AddToAny
- Set 20px as icon size
- Select share buttons that you wish to be included
- Remove all "placement" options

## Like Button Rating ♥ LikeBtn (Optional)
- Adds like/dislike buttons
- Go to "Like Button Rating ♥ LikeBtn" -> Settings
	- Click "Get account data"
	- Create a free account at LikeBtn website, keep in mind license terms (https://likebtn.com/en/pricing)
- Go to "Like Button Rating ♥ LikeBtn" -> Buttons
	- Uncheck "Enable Like Button" for all post types except Buddypress activities and comments.
