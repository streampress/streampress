		...
		<?php if ( 'request-details' == bp_get_current_signup_step() ) : ?>
			...
			<div>
				...
				<form>
					<div class="form-group">
						...
						<input type="text" class="form-control"  name="signup_username" id="signup_username" value="<?php bp_signup_username_value(); ?>" aria-describedby="usernameHelp" placeholder="Enter username" <?php bp_form_field_attributes( 'username' ); ?> />

						<small id="usernameHelp" class="form-text text-muted"><?php _e( 'Username is required.', 'buddypress' ); ?></small>
					</div>

					<div class="form-group">
						<label for="signup_email"><?php _e( 'Email address', 'buddypress' ); ?></label>
						<?php do_action( 'bp_signup_email_errors' ); ?>
						<input type="email" class="form-control" name="signup_email" id="signup_email" value="<?php bp_signup_email_value(); ?>" aria-describedby="emailHelp" placeholder="Enter email" <?php bp_form_field_attributes( 'email' ); ?> />
						<small id="emailHelp" class="form-text text-muted">We'll never share your email with anyone else.</small>
					</div>

					<div class="form-group">
						<label for="signup_password"><?php _e( 'Choose Password', 'buddypress' ); ?></label>
						<?php do_action( 'bp_signup_password_errors' ); ?>
						<input type="password" class="form-control password-entry" name="signup_password" id="signup_password" placeholder="Password" aria-describedby="passwordHelp" <?php bp_form_field_attributes( 'password' ); ?> />
						<small id="passwordHelp" class="form-text text-muted">Password here.</small>
					</div>

					<div class="form-group">
						<label for="signup_password_confirm"><?php _e( 'Confirm Password', 'buddypress' ); ?></label>
						<?php do_action( 'bp_signup_password_confirm_errors' ); ?>
						<input type="password" class="form-control password-entry-confirm" name="signup_password_confirm" id="signup_password_confirm" placeholder="Confirm Password" aria-describedby="confirmPasswordHelp" <?php bp_form_field_attributes( 'password' ); ?> />
						<div id="pass-strength-result"></div>
						<small id="confirmPasswordHelp" class="form-text text-muted"><?php _e( 'Confirm Password', 'buddypress' ); ?></small>
					</div>
					...
					<!-- <button type="submit" class="btn btn-primary"><?php _e( 'Submit', 'buddypress' ); ?></button> -->
			</div>
			...
			<?php if ( bp_is_active( 'xprofile' ) ) : ?>
				...
				<div>
					...
					<h2><?php _e( 'Additional details', 'buddypress' ); ?></h2>
